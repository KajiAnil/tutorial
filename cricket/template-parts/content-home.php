        ...
        <div class="row">
            <div class="col-md-6">
                <?php 
                    ...
                    $args = array('post_type'=>'news_slider','posts_per_page'=>1,'order'=>'desc');
                ...
                ?>
                    ...
                    <div class="post-detail">
                        ...
                        <a href="<?php the_permalink(); ?>" class="btn btn-ckt">Read More</a>
                    </div>
                    <?php endwhile; ?>
                </div>
            ...
            <div class="col-md-6 sub-posts">
                ...
                <div class="row inline-post">
                    ...
                    <div class="news-desc">
                    <h4><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4><?php echo $content; ?></div>
                </div>
            <?php endwhile; ?>
            </div>
        </div>
